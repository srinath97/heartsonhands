...
if(isset($_SESSION['users']))
{
     ...
     {
         //check if payment id already updated
         {
            $q="SELECT payment_id FROM orders WHERE payment_request_id=\"".$_GET['payment_request_id']."\"";
            $r=mysqli_query($stat,$q);
            $r1=mysqli_fetch_array($r);
            if($r1['payment_id']!="")
            {
              if($r1['payment_id']!=$r1['payment_id'])
                header("refresh:0;url=shop.php");
            }
         }
         $q="SELECT * FROM orders WHERE payment_request_id=\"".$_GET['payment_request_id']."\"";
         $r=mysqli_query($stat,$q);
         if(mysqli_num_rows($r)!=0)
         {
           $p1=$_GET['payment_id']; 
           $p2=$_GET['payment_request_id'];
           $q="UPDATE orders SET payment_id=\"".$p1."\" WHERE payment_request_id=\"".$p2."\"";
           mysqli_query($stat,$q);
         }
       ?>
     <!DOCTYPE html>
...
<section class="main__middle__container">
  <div class="container recent-posts">
    <h2 class="page_title text-center"><span>Summary</span><br />
    ...
    <div class="row no-margin no_padding"> 
      ...
      <div style="font-size: 20px; color: green">Payment Succesful</div>
      <div id="webstore">
      ...
      require_once("db.php");
      $uid=$_SESSION['users'];
      $query="SELECT * FROM orders o,order_list ol WHERE o.custid='$uid' and o.id=ol.order_id and custid=".$_SESSION['users']." AND payment_request_id=\"".$_GET['payment_request_id']."\"". "ORDER BY o.id desc";
